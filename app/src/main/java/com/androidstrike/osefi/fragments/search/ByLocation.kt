...
import kotlinx.android.synthetic.main.fragment_by_location.*
import kotlinx.android.synthetic.main.fragment_by_provider_name.*

class ByLocation : Fragment(), IFirebaseLoadDone {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_by_location, container, false)
    }
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        //For search bar
        loadSuggest()
        material_search_bar_locate.lastSuggestions = suggestList
        material_search_bar_locate.setCardViewElevation(5)
        material_search_bar_locate.addTextChangeListener(object : TextWatcher {
            ...
            override fun onTextChanged(s: CharSequence?, start: Int, before: Int, count: Int) {
                ...
                for (search in suggestList){
                    if (search.toLowerCase().contentEquals(material_search_bar_locate.text.toLowerCase()))
                        suggest.add(search)
                }
                material_search_bar_locate.lastSuggestions = suggest
        ...
        material_search_bar_locate.setOnSearchActionListener(object : MaterialSearchBar.OnSearchActionListener{
            override fun onSearchStateChanged(enabled: Boolean) {
                if (!enabled){
                    if (adapter != null)
                        recycler_all_people_locate.adapter = adapter
                }
            }

            override fun onSearchConfirmed(text: CharSequence?) {
                startSearch(text.toString())
                material_search_bar_locate.clearSuggestions()
            }
        ...
        recycler_all_people_locate.setHasFixedSize(true)
        val layoutManager = LinearLayoutManager(activity)
        recycler_all_people_locate.layoutManager = layoutManager
        recycler_all_people_locate.addItemDecoration(
    ...
    private fun startSearch(search_string: String) {
        ...
        val query = FirebaseDatabase.getInstance()
            ...
            .orderByChild("location") // and sort the name of the providers
...
//
        ...
        recycler_all_people_locate.adapter = searchAdapter
    }
        ...
        userList.addListenerForSingleValueEvent(object : ValueEventListener {
            ...
            override fun onDataChange(snapshot: DataSnapshot) {
                for (userSnapshot in snapshot.children) {
                    ...
                    lstUserEmail.add(user!!.location!!)
                }
    ...
    override fun onFirebaseUserDone(lstEmail: List<String>) {
        material_search_bar_locate.lastSuggestions = lstEmail
    }
